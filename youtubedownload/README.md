...
3. **動画をダウンロード**:
   - URL入力フィールドに動画のURLを貼り付け
   - 「動画情報を取得」ボタンをクリック
   - 動画プレビューが表示されたら「ダウンロード開始」
   - リアルタイムで進捗が表示されます
   - 完了後、ファイルをダウンロードできます

#### 機能

- **動画プレビュー**: サムネイル、タイトル、長さ、視聴回数などを表示
- **リアルタイム進捗**: WebSocketによるライブ進捗表示
- **ダウンロード履歴**: 過去にダウンロードした動画の履歴を表示
- **モダンUI**: ダークテーマ、グラデーション、アニメーション
